 ...
 * 
 * FASE 3 do processo TireCalibration:
...
class ClaudeRefinementService
{
     ...
     */
    public function refineCalibrationArticle(TireCalibration $calibration): ?array
    {
     ...
     */
    private function buildRefinementPrompt(TireCalibration $calibration, array $structuredArticle): string
    {
        $vehicleInfo = [
...
EOT;
    ...
    public function getRefinementStats(): array
    {
        ...
        $refined = TireCalibration::whereNotNull('article_refined')->count();
