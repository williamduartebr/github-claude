...
namespace Src\ContentGeneration\WhenToChangeTiresWithYear\Infrastructure\Console\Commands\Schedules;

use Illuminate\Console\Scheduling\Schedule;

class SyncBlogWhenToChangeTireSchedule
{
    /**
    ...
    private static function registerMinutelySync(Schedule $schedule): void
    {
        ...
        $schedule->command('change-tires:sync-blog --limit=10')
            ->everyMinute()
    ...
    private static function registerHourlySync(Schedule $schedule): void
    {
        ...
        $schedule->command('change-tires:sync-blog --limit=50')
            ->hourly()
