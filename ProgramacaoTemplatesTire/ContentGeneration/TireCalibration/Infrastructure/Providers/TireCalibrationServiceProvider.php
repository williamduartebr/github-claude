...
use Src\ContentGeneration\TireCalibration\Infrastructure\Commands\PublishTireCalibrationHumanizedArticlesCommand;
...
use Src\ContentGeneration\TireCalibration\Infrastructure\Commands\CorrectGenericVersionsPremiumCommand;
use Src\ContentGeneration\TireCalibration\Infrastructure\Commands\CorrectGenericVersionsStandardCommand;
use Src\ContentGeneration\TireCalibration\Infrastructure\Commands\PublishTireCalibrationArticlesCommand;
use Src\ContentGeneration\TireCalibration\Infrastructure\Commands\CorrectGenericVersionsIntermediateCommand;
    ...
    private function registerCommandsV4(): void
    {
        if ($this->app->runningInConsole()) {
            $this->commands([
                ...
                // CorrectGenericVersionsStandardCommand::class,
                // CorrectGenericVersionsIntermediateCommand::class,
                // CorrectGenericVersionsPremiumCommand::class,
                ...
                // PublishTempTireCalibrationArticlesCommand::class,
                // PublishTireCalibrationArticlesCommand::class,
                ...
                // PublishTireCalibrationHumanizedArticlesCommand::class,
