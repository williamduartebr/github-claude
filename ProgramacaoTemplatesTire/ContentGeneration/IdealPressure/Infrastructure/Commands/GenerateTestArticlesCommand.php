 ...
 * 
 * USO:
 * php artisan ideal-pressure:generate-test-articles
 * php artisan ideal-pressure:generate-test-articles --category=sedan
 * php artisan ideal-pressure:generate-test-articles --save-to-disk
 * php artisan ideal-pressure:generate-test-articles --validate-only
 * 
...
class GenerateTestArticlesCommand extends Command
{
     ...
     */
    protected $signature = 'ideal-pressure:generate-test-articles
        ...
        try {
            ...
            foreach ($testResults as $category => $article) {
                ...
                $article['_file_metadata'] = [
                    ...
                    'category' => $category,
                    'filename' => $filename,
                    'command' => 'ideal-pressure:generate-test-articles'
                ];
    ...
    private function displayRecommendations(array $validationResults): void
    {
        ...
        $this->line('   2. Execute: php artisan ideal-pressure:generate-articles');
        $this->line('   3. Compare estrutura real vs. teste');
        $this->line('   4. Monitore: php artisan ideal-pressure:stats');
    }
}
