...
use Src\ContentGeneration\IdealPressure\Infrastructure\Commands\GenerateArticlesPhase12Command;
...
class IdealPressureServiceProvider extends ServiceProvider
{
    ...
    private function registerCommands(): void
    {
        if ($this->app->runningInConsole()) {
            $this->commands([
                ...
                GenerateArticlesPhase12Command::class,  // FASE 1+2: VehicleData → JSON estruturado
    ...
    public function provides(): array
    {
        return [
            ...
            // Commands
            CopyIdealPressureArticlesCommand::class,
            GenerateArticlesPhase12Command::class,
