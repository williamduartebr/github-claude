...
<div class="search-component" id="search-component">
    <button {{ $attributes->merge(['class' => 'text-yellow-400 p-2 '.$class, 'id' => 'search-button']) }}
    ...
    <div id="search-modal"
        ...
        <div class="w-full max-w-3xl mx-2 md:mx-0.5 p-4 md:p-8 bg-white dark:bg-gray-800 rounded-lg shadow-2xl">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white font-montserrat">Buscar Artigos, Dicas e Notícias</h2>
            ...
            <form action="https://cse.google.com/cse" method="get">
                <input type="hidden" name="cx" value="f46fd650c78034716">
                    ...
                    <div class="flex-grow">
                        <div class="relative">
                            ...
                            <input type="text" name="q" id="search-input"
                                class="w-full py-4 pl-10 pr-4 text-lg bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                style="color: #1f2937 !important;" placeholder="O que você está procurando?" required>
                        </div>
                    </div>
                    <button type="submit"
