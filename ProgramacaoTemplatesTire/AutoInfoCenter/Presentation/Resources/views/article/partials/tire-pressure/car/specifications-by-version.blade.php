{{-- 
Partial: tire-pressure/car/specifications-by-version.blade.php
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors {{ $index === 0 ? 'bg-blue-50' : '' }}">
                        <!-- Versão -->
            ...
            <div class="flex items-start">
                ...
                <div class="text-sm">
                    ...
                    <p class="text-purple-700">
                        Este {{ $vehicleInfo['full_name'] ?? 'veículo' }} pode ter diferentes modos de condução que ajustam automaticamente 
