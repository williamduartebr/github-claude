{{-- 
Partial: tire-pressure/car/full-load-table.blade.php
        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-blue-100 text-sm">
                    {{ $fullLoadTable['description'] ?? 'Use estes valores quando o veículo estiver com lotação máxima e bagagem.' }}
                </p>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors {{ $condition['css_class'] ?? '' }}">
                        ...
                        <td class="py-4 px-4 text-sm font-semibold text-gray-900">
                            <div class="flex items-center">
                                <div class="w-8 h-8 rounded-full {{ $index === 0 ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-600' }} flex items-center justify-center mr-3 text-xs font-bold">
                                    {{ $index + 1 }}
                                </div>
                                <div>
                                    <div class="font-semibold">{{ $condition['condition'] ?? $condition['version'] ?? 'Padrão' }}</div>
                        ...
                        <td class="py-4 px-4 text-sm text-gray-600">
                            ...
                            <div class="flex items-start">
                                <svg class="w-4 h-4 text-yellow-500 mr-1 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex items-start">
                ...
                <div class="text-sm">
                    ...
                    <p class="text-green-700">
                        Pressões corretas são ainda mais importantes em veículos elétricos, pois impactam diretamente na autonomia da bateria. 
            ...
            <div class="flex items-start">
                ...
                <div class="text-sm">
                    ...
                    <p class="text-blue-700">
                        Pressões adequadas podem melhorar o consumo de combustível em até 3% e aumentar a vida útil dos pneus em até 25%.
                    </p>
                </div>
            </div>
        </div>
