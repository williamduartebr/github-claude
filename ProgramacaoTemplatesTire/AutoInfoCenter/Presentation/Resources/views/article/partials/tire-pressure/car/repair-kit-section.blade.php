{{-- 
Partial: partials/tire-pressure/car/repair-kit-section.blade.php
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="text-center">
                        ...
                        <div class="bg-white/20 rounded-lg p-4">
                            <div class="text-lg font-bold mb-2">
                                {{ $emergencyEquipment['kit_components']['sealant']['description'] ?? 'Reparo Temporário' }}
                            </div>
                            <div class="text-orange-200 text-sm">
                                {{ $emergencyEquipment['kit_components']['sealant']['limitations'] ?? 'Para furos até 4mm' }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="bg-white/20 rounded-lg p-4">
                            ...
                            <div class="text-orange-200 text-sm">
                                {{ $emergencyEquipment['kit_components']['compressor']['power_source'] ?? 'Tomada 12V do veículo' }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <ol class="space-y-3">
                    ...
                    <li class="flex items-start">
                        <span class="bg-orange-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">
                            {{ $index + 1 }}
                        </span>
            ...
            <table class="min-w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="border border-gray-300 px-4 py-2 text-left font-semibold text-gray-900">Observação</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="bg-green-50">
                        <td class="border border-gray-300 px-4 py-2 font-medium">Após usar o kit</td>
                        <td class="border border-gray-300 px-4 py-2 font-bold text-green-700">{{ $emergencyEquipment['normal_pressure'] ?? 35 }}</td>
                        <td class="border border-gray-300 px-4 py-2">{{ round(($emergencyEquipment['normal_pressure'] ?? 35) * 0.070307, 2) }}</td>
                    ...
                    <tr class="bg-yellow-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-yellow-700">Apenas para chegar à borracharia</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-purple-600 text-xs">
                    <strong>Telefone:</strong> {{ $emergencyEquipment['emergency_contacts']['phone'] ?? 'Consulte manual do proprietário' }}<br>
                    <strong>Disponibilidade:</strong> {{ $emergencyEquipment['emergency_contacts']['availability'] ?? '24h' }}
                </p>
            </div>
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm">
                ...
                <p class="text-amber-700">
                    ...
                    @elseif($isHybrid)
                    Em veículos híbridos, a ausência do estepe otimiza peso e distribuição para o sistema elétrico/combustão.
                    @else
