{{-- 
Partial: tire-pressure/car/special-conditions.blade.php
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <div class="flex items-center mb-4">
                <div class="w-12 h-12 rounded-full bg-gradient-to-br from-[#0E368A]/10 to-[#0E368A]/20 flex items-center justify-center mr-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">{{ $condition['title'] ?? $condition['condition'] ?? 'Condição Especial' }}</h3>
            ...
            <table class="min-w-full border-collapse bg-white rounded-lg overflow-hidden">
                ...
                <tbody class="text-xs">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="py-2 px-3 text-center text-orange-600 font-bold">Tabela de carga + ajuste climático</td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50">
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm">
                ...
                <p class="text-yellow-700">
                    Estas são orientações gerais baseadas nas especificações do {{ $vehicleInfo['full_name'] ?? 'veículo' }}. 
