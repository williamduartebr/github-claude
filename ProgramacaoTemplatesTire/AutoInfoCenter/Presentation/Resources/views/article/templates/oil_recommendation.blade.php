...
<main id="main-content" class="container mx-auto px-4">
    <div itemscope itemtype="https://schema.org/TechArticle">
        ...
        @endif
        <meta itemprop="category" content="{{ $article->category['name'] ?? 'Óleo Recomendado' }}" />

        <article class="max-w-4xl mx-auto pt-6 pb-12">

            <!-- Header -->
             @include('auto-info-center::article.partials.oil-recommendation.header')
            ...
            @include('auto-info-center::article.partials.oil-recommendation.main-recommendations')

            <!-- Especificações Técnicas -->
            @include('auto-info-center::article.partials.oil-recommendation.specifications')
            ...
            @include('auto-info-center::article.partials.oil-recommendation.benefits')

            <!-- Condições Especiais de Uso -->
            @include('auto-info-center::article.partials.oil-recommendation.usage-conditions')
            ...
            @include('auto-info-center::article.partials.oil-recommendation.change-procedure')

            <!-- Perguntas Frequentes -->
            @include('auto-info-center::article.partials.oil-recommendation.faq')
...
@push('styles')
@include('auto-info-center::article.partials.oil-recommendation.styles')
@endpush

@push('scripts')
@include('auto-info-center::article.partials.oil-recommendation.scripts')
@endpush