                    ...
                    <tbody>
                        ...
                        <tr style="background: white;">
                            <td style="text-align: left; padding-left: 16px; font-weight: 500;">
                                ...
                                <small style="font-size: 12px; color: #6b7280;">{{ $oficial['piloto_solo']['observacao'] ?? 'Uso normal' }}</small>
                            </td>
                            <td><span class="pressure-badge">{{ $oficial['piloto_solo']['dianteira'] }}</span></td>
                            <td><span class="pressure-badge">{{ $oficial['piloto_solo']['traseira'] }}</span></td>
                        ...
                        <tr style="background: #f8fafc;">
                            <td style="text-align: left; padding-left: 16px; font-weight: 500;">
                                ...
                                <small style="font-size: 12px; color: #6b7280;">{{ $oficial['piloto_garupa']['observacao'] ?? 'Com passageiro' }}</small>
                            </td>
                            <td><span class="pressure-badge">{{ $oficial['piloto_garupa']['dianteira'] }}</span></td>
                            <td><span class="pressure-badge">{{ $oficial['piloto_garupa']['traseira'] }}</span></td>
