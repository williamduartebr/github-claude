...
<main id="main-content" class="container mx-auto px-4">
    <div itemscope itemtype="https://schema.org/TechArticle">
        ...
        <article class="max-w-4xl mx-auto pt-6 pb-12">
            ...
            @include('auto-info-center::article.partials.review-schedule.electric.header')
            ...
            <!-- Resumo das Revisões -->
            @include('auto-info-center::article.partials.review-schedule.electric.overview_schedule')

            <!-- Timeline de Revisões Detalhadas -->
            @include('auto-info-center::article.partials.review-schedule.electric.detailed_schedule')
            ...
            @include('auto-info-center::article.partials.review-schedule.electric.preventive_maintenance')

            <!-- Peças que Exigem Atenção -->
            @include('auto-info-center::article.partials.review-schedule.electric.critical_parts')
            ...
            @include('auto-info-center::article.partials.review-schedule.electric.warranty_info')

            <!-- Perguntas Frequentes -->
            @include('auto-info-center::article.partials.review-schedule.electric.faq')
...
@push('styles')
@include('auto-info-center::article.partials.review-schedule.electric.styles')
@endpush

@push('scripts')
@include('auto-info-center::article.partials.review-schedule.electric.scripts')
@endpush