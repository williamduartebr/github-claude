    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
        ...
        <article class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full" itemprop="hasPart" itemscope
            ...
            <div class="relative">
                ...
                @if($index < 3)
                <div class="absolute top-0 right-0 bg-blue-600 text-white text-xs font-bold px-2 py-1 m-1 rounded font-montserrat">
                    TOP
                </div>
                @elseif($article->created_at->diffInDays() < 7)
                <div class="absolute top-0 right-0 bg-green-600 text-white text-xs font-bold px-2 py-1 m-1 rounded font-montserrat">
                    NOVO
                </div>
                @endif
            </div>
