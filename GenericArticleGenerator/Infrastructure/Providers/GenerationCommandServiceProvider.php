...
use Src\GenericArticleGenerator\Commands\SeedOilTableArticlesCommand;
use Src\GenericArticleGenerator\Commands\SeedBlogArticlesCommand;
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                ...
                // SeedBlogArticlesCommand::class,
                SeedOilTableArticlesCommand::class,
