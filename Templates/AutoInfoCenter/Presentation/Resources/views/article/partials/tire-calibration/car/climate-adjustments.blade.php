...
<section class="mb-12">
    <div class="hidden md:block bg-gradient-to-br from-sky-600 to-blue-700 text-white rounded-lg p-8 relative overflow-hidden">
        <!-- Ícone decorativo -->
    ...
    <div class="hidden mt-6 md:grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Época de Chuvas -->
    ...
    <!-- Alerta Importante -->
    <div class="hidden md:block mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
