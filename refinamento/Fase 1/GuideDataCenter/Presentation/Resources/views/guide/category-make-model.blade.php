...
<section class="bg-white border-b border-gray-200">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p class="text-sm text-gray-600 font-roboto">
            Escolha o ano do seu {{ $make['name'] }} {{ $model['name'] }} para ver o guia completo de {{
            ...
            <table class="min-w-full text-sm font-roboto">
                ...
                <tbody>
                    ...
                    <tr class="border-t border-gray-200 {{ $index % 2 === 1 ? 'bg-gray-50' : '' }}">
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ $yearData['url'] }}" class="text-blue-600 hover:underline font-medium">
                                Ver guia →
                            </a>
                        </td>
                    </tr>
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-yellow-800 mt-1 font-roboto">
                        Ainda não temos guias de {{ strtolower($category['name']) }} para o {{ $make['name'] }} {{
                        $model['name'] }}.
