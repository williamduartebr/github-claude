    ...
    <div class="container mx-auto px-4 py-10">
        <div class="md:flex md:items-center md:justify-between gap-8">
            ...
            <div class="mt-6 md:mt-0">
                <div class="flex flex-col gap-5 bg-gray-100 border border-gray-300 rounded-lg p-4 text-center text-sm text-gray-700 font-roboto">
                    <span><strong class="block font-montserrat">{{ $stats['total_makes'] }}</strong> marcas</span>
                   
                    <span><strong class="block font-montserrat mt-1">{{ $stats['total_models'] }}+</strong> modelos</span>
                </div>
            </div>
            ...
            @foreach($featuredMakes as $make)
                <a href="{{ $make['url'] }}" 
                   class="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg hover:border-blue-500 transition-all duration-300 flex flex-col items-center justify-center group">
                    ...
                    <h3 class="text-center font-semibold text-gray-900 group-hover:text-blue-600 transition-colors font-montserrat text-sm">
                        {{ $make['name'] }}
                    </h3>
                </a>
            @endforeach
