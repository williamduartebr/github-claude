        ...
        <div class="md:flex md:items-start md:justify-between gap-8">
            <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-2 mb-5">
                    ...
                    <span
                        class="inline-flex items-center px-3 py-1 bg-{{ $badge['color'] }}-50 text-{{ $badge['color'] }}-700 text-xs font-medium rounded-full border border-{{ $badge['color'] }}-200">
                        @if($badge['icon'] === 'check')
            ...
            <div class="md:w-72 mt-6 md:mt-0">
                ...
                <img src="/images/placeholder/corolla-full-hero.jpeg" alt="{{ $version['full_name'] }}"
                    class="w-full rounded shadow">
                {{--
                <img src="{{ $version['image'] }}" alt="{{ $version['full_name'] }}" class="w-full rounded shadow"> --}}
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <section class="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-8">
        <h2 class="text-xl font-semibold mb-4 font-montserrat">Ficha Técnica – {{ $version['name'] }} {{
            $version['year'] }}</h2>
        ...
        <section class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-sm p-6 border border-blue-100">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-gray-900 mb-2 font-montserrat">Equipe Editorial Mercado
                            Veículos</h3>
                        <p class="text-sm text-gray-700 leading-relaxed font-roboto mb-3">
                            Esta ficha técnica foi desenvolvida com base em especificações oficiais da fabricante {{
                            $make['name'] }}, manuais do proprietário e dados técnicos verificados. Nossa equipe
                            editorial segue um rigoroso processo de verificação para garantir a precisão das informações
                            apresentadas.
                        </p>
                        <p class="text-sm text-gray-700 leading-relaxed font-roboto mb-4">
                            <strong>Processo editorial:</strong> Coleta de dados oficiais → Verificação cruzada →
                            Revisão técnica → Publicação → Atualizações periódicas
                        </p>
                        <a href="/sobre/metodologia-editorial"
                            class="inline-flex items-center text-blue-700 hover:text-blue-800 font-medium text-sm font-roboto">
