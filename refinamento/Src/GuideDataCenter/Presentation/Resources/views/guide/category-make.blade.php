        ...
        <div class="md:flex md:items-center md:justify-between gap-8">
            <div class="max-w-2xl">
                ...
                <p class="text-sm text-gray-600 font-roboto">
                    ...
                    especificações, recomendações e informações válidas para todas as versões e motores do ano selecionado.
                </p>
            </div>
    ...
    <section class="bg-white border border-gray-200 rounded-lg p-4 mb-10">
        <form class="grid grid-cols-1 md:grid-cols-6 gap-3">
            ...
            <div class="md:col-span-1 flex items-end">
                <button
                    class="w-full bg-blue-600 text-white text-sm px-3 py-2 rounded hover:bg-blue-700 font-roboto">
                    Buscar
                </button>
            </div>
        </form>
