...
<article class="guide-article" itemscope itemtype="https://schema.org/Article">
    ...
    <nav class="breadcrumb" aria-label="Navegação">
        <ol class="breadcrumb-list" itemscope itemtype="https://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                <a href="{{ route('guide.byModel', ['make' => $guide->makeSlug, 'model' => $guide->modelSlug]) }}" itemprop="item">
...
<nav class="guide-navigation">
    <a href="{{ route('guide.byModel', ['make' => $guide->makeSlug, 'model' => $guide->modelSlug]) }}" class="btn btn-outline">
        ← Ver todos os guias para {{ $guide->make }} {{ $guide->model }}
    </a>
    
    <a href="{{ route('guide.cluster', ['make' => $guide->makeSlug, 'model' => $guide->modelSlug]) }}" class="btn btn-outline">
