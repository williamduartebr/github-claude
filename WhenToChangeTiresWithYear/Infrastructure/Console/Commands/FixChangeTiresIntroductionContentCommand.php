...
use Src\ContentGeneration\WhenToChangeTiresWithYear\Infrastructure\Services\ArticleChangeTiresIntroductionCorrectionService;


class FixChangeTiresIntroductionContentCommand extends Command
{
    /**
     * Nome e assinatura do comando
     */
    protected $signature = 'articles:change-tires-fix-introduction 
    ...
    protected ArticleChangeTiresIntroductionCorrectionService $correctionService;

    /**
     * Construtor
     */
    public function __construct(ArticleChangeTiresIntroductionCorrectionService $correctionService)
    {
        parent::__construct();
