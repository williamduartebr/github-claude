...
<section class="mb-12">
    ...
    <div class="hidden md:block mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
    ...
    <!-- Matriz de Decisão -->
    <div class="hidden md:block mt-6 bg-gray-50 rounded-lg p-6">
