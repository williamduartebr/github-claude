...
<section class="mb-12">
    <h2 class="text-2xl font-semibold text-[#151C25] mb-6 pb-2 border-b border-gray-200">Melhores Pneus
        Traseiros para {{ $article->vehicle_info['make'] ?? 'Veículo' }} {{ $article->vehicle_info['model']
        ?? '' }}</h2>
        ...
        <div
            ...
            <div class="p-5">
                <div class="flex items-center justify-center mb-4">
                    <span
                        class="inline-block bg-{{ $tire['categoria'] === 'Melhor Custo-Benefício' ? '[#E06600]' : 'gray-200' }} text-{{ $tire['categoria'] === 'Melhor Custo-Benefício' ? 'white' : 'gray-800' }} text-xs font-medium px-2.5 py-1 rounded">
