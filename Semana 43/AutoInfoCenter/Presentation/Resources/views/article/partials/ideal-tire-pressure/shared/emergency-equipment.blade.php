{{--
Partial Master: partials/ideal-tire-pressure/shared/emergency-equipment.blade.php
...
--}}
@include('auto-info-center::article.partials.ideal-tire-pressure.car.spare-tire-section')
@else
{{--
KIT DE REPARO: Quando pressure_spare = 0
Exemplos: Mercedes EQA 2025 (elétrico), outros premium sem estepe
--}}
@include('auto-info-center::article.partials.ideal-tire-pressure.car.repair-kit-section')
@endif
