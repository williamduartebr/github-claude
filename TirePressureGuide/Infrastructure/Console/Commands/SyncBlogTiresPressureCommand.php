...
class SyncBlogTiresPressureCommand extends Command
{
    protected $signature = 'tires-pressure:sync-blog {--limit=10}';
    protected $description = 'Sync blog data for change tires articles';
    ...
    public function handle(): ?int
    {
        ...
        $articles = TirePressureArticle::whereNotNull('wordpress_url')
    ...
    private function syncArticle(TirePressureArticle $article): void
    {
        try {
            $url = "https://blog.mercadoveiculos.com/?get_json=1&slug={$article->wordpress_url}";
