...
class ReviewScheduleCarViewModel extends TemplateViewModel
{
      ...
      private function processStructuredDataForSEO(): void
    {
        ...
        if (empty($article->vehicle_info['vehicle_type'])) {
            ...
            $imageDefault = "https://mercadoveiculos.s3.us-east-1.amazonaws.com/info-center/images/default/revisoes-{$vehicleInfo['vehicle_type']}.png";
        }

        // Constrói informações estruturadas para manutenção automotiva
