    ...
    <div itemscope itemtype="https://schema.org/TechArticle">
        ...
        <article class="max-w-4xl mx-auto pt-6 pb-12">
            ...
            <section class="mb-12">
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden border-l-4 border-blue-500">
            ...
            <section class="mb-12">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden border-l-4 border-blue-400">
                        <div class="p-5">
