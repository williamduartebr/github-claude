        ...
        <div class="bg-[#0E368A]/5 rounded-lg p-6 border border-gray-200 shadow-sm">
            ...
            <div class="text-gray-700 space-y-2 pl-3 ml-10 border-l-2 border-[#0E368A]/40">
                <p class="text-sm leading-relaxed">
                    Conteúdo desenvolvido com base em especificações técnicas oficiais da {{ $article->getData()['vehicle_info']['make'] ?? 'montadora' }} e testes práticos realizados por nossa equipe.
                </p>
                <p class="text-sm leading-relaxed">
