{{--
Partial: partials/ideal-tire-pressure/car/spare-tire-section.blade.php
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start">
                        <span
                            class="bg-indigo-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5">
                            {{ $index + 1 }}
                        </span>
            ...
            <table class="min-w-full border-collapse border border-gray-300">
                ...
                <tbody>
                    <tr class="bg-yellow-50 border-yellow-200">
                        <td class="border border-gray-300 px-4 py-2 font-bold text-yellow-800">{{
                            $emergencyEquipment['pressure'] ?? 60 }}</td>
                        <td class="border border-gray-300 px-4 py-2">{{ round(($emergencyEquipment['pressure'] ?? 60) *
                            0.070307, 2) }}</td>
                        <td class="border border-gray-300 px-4 py-2">{{ round(($emergencyEquipment['pressure'] ?? 60) *
                            0.0689476, 2) }}</td>
                        <td class="border border-gray-300 px-4 py-2 text-yellow-800 font-medium">🎯 Pressão do Estepe
                        </td>
                    </tr>
                </tbody>
            </table>
