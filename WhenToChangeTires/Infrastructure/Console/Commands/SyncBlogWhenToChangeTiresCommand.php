...
class SyncBlogWhenToChangeTiresCommand extends Command
{
    protected $signature = 'change-tires:sync-blog {--limit=10}';
    ...
    public function handle(): int
    {
        ...
        $articles = TireChangeArticle::whereNotNull('wordpress_url')
    ...
    private function syncArticle(TireChangeArticle $article): void
    {
        try {
