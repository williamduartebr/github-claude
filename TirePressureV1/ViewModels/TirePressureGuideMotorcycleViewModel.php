...
class TirePressureGuideMotorcycleViewModel extends TemplateViewModel
{
    ...
    private function processVehicleInfo(): array
    {
        ...
        return [
            ...
            'category' => $vehicleInfo['category'] ?? 'motocicleta',
            'engine' => $vehicleInfo['engine'] ?? '',
            'displacement' => $vehicleInfo['cilindrada'] ?? '',
    ...
    private function isSportMotorcycle(): bool
    {
        ...
        $type = strtolower($this->article->vehicle_info['tipo'] ?? '');
    ...
    private function processSeoData(): array
    {
        ...
        return [
            ...
            'focus_keyword' => "calibragem pneu {$this->article->vehicle_info['make']} {$this->article->vehicle_info['model']} {$this->article->vehicle_info['year']}",
